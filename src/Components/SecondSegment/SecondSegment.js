            ...
            <div className='container mainCont'>
               <div className='left'>
                    <div className='TitleS'>
                        <h2 className='titles'>Improving the Quality of Your Life through Better Health</h2>
                    </div>
                    <div id='subTitleS'>
                       <h3>Our goal is to deliver quality of care in a courteous, respectful, and compassionate manner. We hope you will allow us to care for you and to be the first and best choice for healthcare.
            </h3>        </div>
                    <div id='Stext'>
